                    ...
                    <div wire:key="{{ $category->id }}">
                        ...
                        {{ in_array($category->id, $selectedBadges) ? 'text-white bg-indigo-600 hover:bg-indigo-800' : 'text-indigo-800 dark:bg-indigo-900 dark:text-indigo-300' }}">
                            {{ $category->name }}
                                ...
                                <a class="flex items-center  p-0.5 ml-2 text-sm text-indigo-400 bg-transparent rounded-sm hover:bg-indigo-300 hover:text-indigo-900 dark:hover:bg-indigo-800 dark:hover:text-indigo-300">
